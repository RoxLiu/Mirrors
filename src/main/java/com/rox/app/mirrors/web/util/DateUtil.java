...
public class DateUtil {
     ...
     * DateFormat:yyyy-MM-dd
     */
    public static final String FORMATE_YYYY_MM_DD_MINUS2 = "yyyy/MM/dd";
     ...
     */
    public static final String FORMATE_YY_MM_DD_HH_MM_SS = "yyMMddHHmmss";
     ...
     * 年月日时分
     */
    public static final String CHN_FORMATE_YYYY_MM_DD_HH_MM = "yyyy年MM月dd日HH时mm分";
...
//		System.out.println(compareCurrentTime("12:23:20","15:23:14"));
        ...
        System.out.println(addDay(dt2));


        System.out.println(convertDateToStr(new Date(), CHN_FORMATE_YYYY_MM_DD_HH_MM));
    }
