...
function windowUploadSuccess(file, data, response) {
    ...
    var $container = $.pdialog.getCurrent() != null && $.pdialog.getCurrent().length > 0 ? $.pdialog.getCurrent() : $("#rightContent");
...
function selOrgCallBackInTab(treeNode) {

    $("#rightContent").find("#orgName").val(treeNode.name);
    $("#rightContent").find("#orgId").val(treeNode.id);
}