...
(function ($) {
    ...
    function _342(_343, _344, _345) {
        ...
        function _34a() {
            ...
            if (_344 == "east") {
                return {
                    resizeC: {width: _346.center.panel("options").width + _346["east"].panel("options").width - 28},
                    expand: {left: cc.width() - _346["east"].panel("options").width},
                    expandP: {
                ...
                if (_344 == "west") {
                    return {
                        ...
                        collapse: {left: -_346["west"].panel("options").width}
                    };
                } else {
                    if (_344 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_346["north"].panel("options").height}
                        };
                    } else {
                        if (_344 == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _346["south"].panel("options").height},
                ...
                if (_34e == "west" && _34f.expandWest) {
                    ...
                    if (_34e == "north" && _34f.expandNorth) {
                        ...
                        if (_34e == "south" && _34f.expandSouth) {
                            return {
                                collapse: {top: cc.height()},
                                expand: {top: cc.height() - _34f["south"].panel("options").height}
                            };
                        }
                    }
                }
...
(function ($) {
    ...
    $.fn.timespinner.parseOptions = function (_485) {
        return $.extend({}, $.fn.spinner.parseOptions(_485), $.parser.parseOptions(_485, ["separator", {
            showSeconds: "boolean",
            highlight: "number"
        }]));
    };
...
(function ($) {
    ...
    $.fn.datagrid.parseOptions = function (_62b) {
        var t = $(_62b);
        return $.extend({}, $.fn.panel.parseOptions(_62b), $.parser.parseOptions(_62b, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
            fitColumns: "boolean",
        ...
        return this.each(function () {
            ...
            if (_740) {
                ...
                _740 = $.data(this, "treegrid", {
                    options: $.extend({}, $.fn.treegrid.defaults, $.fn.treegrid.parseOptions(this), _73d),
                    data: []
                });
            }
            _6be(this);
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_7d3) {
                ...
                _7d3 = $.data(this, "combo", {
                    options: $.extend({}, $.fn.combo.defaults, $.fn.combo.parseOptions(this), _7d1),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function (_7d8) {
        var t = $(_7d8);
        return $.extend({}, $.fn.validatebox.parseOptions(_7d8), $.parser.parseOptions(_7d8, ["width", "height", "separator", {
            panelWidth: "number",
            editable: "boolean",
...
(function ($) {
        ...
        return this.each(function () {
            ...
            if (_8b5) {
                ...
                _8b5 = $.data(this, "slider", {
                    options: $.extend({}, $.fn.slider.defaults, $.fn.slider.parseOptions(this), _8b3),
                    slider: init(this)
                });
                $(this).removeAttr("disabled");
            }
    ...
    $.fn.slider.parseOptions = function (_8b8) {
        var t = $(_8b8);
        return $.extend({}, $.parser.parseOptions(_8b8, ["width", "height", "mode", {
            reversed: "boolean",
            showTip: "boolean",
            min: "number",
            max: "number",
