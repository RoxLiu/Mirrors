...
!function (e) {
    ...
    function n() {
        function e(r, s) {
            if (!o[r] && !c(r, F)) {
                o[r] = 1, c(r, J) || n[r] || (n[r] = 1, t.push(r));
                var l = z[r];
    ...
    function l(e) {
        ...
        if (t && !c(e, M)) {
            ...
            }), t.state = M, m(e), g(o), r.length && t.require(r, function () {
                C(t.depRs, function (t) {
                    t.absId || (t.absId = v(t.id, e))
                }), h()
            })
        }
    }
    ...
    function _() {
        ...
        N.baseUrl = N.baseUrl.replace(/\/$/, "") + "/", G = b(N.paths), Z = b(N.map, 1), C(Z, function (e) {
            ...
            "string" == typeof e && (t = {
                ...
                location: e,
                main: "main"
            }), t.location = t.location || t.name, t.main = (t.main || "main").replace(/\.js$/i, ""), t.reg = S(t.name), Y.push(t)
    ...
    function L(e) {
        function i(i, a) {
            if ("string" == typeof i) {
                if (!n[i]) {
                    var o = v(i, e);
                    if (p(o), !c(o, F))throw new Error('[MODULE_MISS]"' + o + '" is not exists!');
                    n[i] = z[o].exports
                }
                return n[i]
            }
            if (i instanceof Array) {
                var r = [], s = [];
                C(i, function (i, n) {
                    var a = w(i), o = v(a.mod, e), l = a.res, h = o;
                    if (l) {
                        var d = o + "!" + l;
    ...
    s.version = "2.2.1", s.dependencies = {zrender: "2.0.8"}, s.init = function (t, n) {
        var a = e("zrender");
    ...
    return i.prototype = {
        _init: function () {
            ...
            if (this._mergeGlobalConifg(t), !this._noDataCheck(t)) {
                ...
                var y = "IMG" + this.id, f = document.getElementById(y);
                t.renderAsImage && l ? (f ? f.src = this.getDataURL(t.renderAsImage) : (f = this.getImage(t.renderAsImage), f.id = y, f.style.position = "absolute", f.style.left = 0, f.style.top = 0, this.dom.firstChild.appendChild(f)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : f && f.parentNode.removeChild(f), f = null, this._option = t
            }
        }, restore: function () {
            ...
            function s() {
                if (X._zr) {
                    ...
                    for (var e = 0, t = v.length; t > e; e++)v[e].motionlessOnce = h.addDataAnimation && v[e].addDataAnimation;
                ...
                if (p) {
                    ...
                    if (U[u](t), g[u](t), n || (U[V](), t = g[V]()), null != r) {
                        ...
                        if (p.type === a.CHART_TYPE_PIE && (y = d.legend) && (f = y.data)) {
                            var b = h.legend.data;
                            if (f[u](r), b[u](r), !n) {
                                var _ = o.indexOf(f, t.name);
                                -1 != _ && f.splice(_, 1), _ = o.indexOf(b, t.name), -1 != _ && b.splice(_, 1)
                            }
                        } else if (null != d.xAxis && null != d.yAxis) {
                            var x, k, L = p.xAxisIndex || 0;
                            (null == d.xAxis[L].type || "category" === d.xAxis[L].type) && (x = d.xAxis[L].data, k = h.xAxis[L].data, x[u](r), k[u](r), n || (x[V](), k[V]())), L = p.yAxisIndex || 0, "category" === d.yAxis[L].type && (x = d.yAxis[L].data, k = h.yAxis[L].data, x[u](r), k[u](r), n || (x[V](), k[V]()))
                        }
                    }
            ...
            for (var v = this._chartList, W = 0, w = function () {
                W--, 0 === W && s()
            }, m = 0, c = v.length; c > m; m++)h.addDataAnimation && v[m].addDataAnimation && (W++, v[m].addDataAnimation(l, w));
    ...
    function r() {
        return p || (c = document.createElement("canvas"), u = c.width, V = c.height, p = c.getContext("2d")), p
    }

    function s(e, t) {
        var i, n = 100;
        e + y > u && (u = e + y + n, c.width = u, i = !0), t + f > V && (V = t + f + n, c.height = V, i = !0), -y > e && (y = Math.ceil(-e / n) * n, u += y, c.width = u, i = !0), -f > t && (f = Math.ceil(-t / n) * n, V += f, c.height = V, i = !0), i && p.translate(y, f)
    }
    ...
    }, g = Object.prototype.toString, y = 0, f = 0;
    return {
        inherits: d,
        clone: i,
        merge: a,
    ...
    d.version = "2.0.8", d.init = function (e) {
        var t = new m(a(), e);
        return h[t.id] = t, t
    ...
    return m.prototype.getId = function () {
        ...
        if ("string" == typeof e && (e = this.storage.get(e)), e) {
            ...
            var m = e.__animators;
            0 === m.length && d.push(e);
            var c = this.animation.animate(o, {loop: a}).done(function () {
        ...
        if (e.__animators) {
            ...
            if (n > 0) {
                var o = this.animatingElements, r = i.indexOf(o, e);
                r >= 0 && o.splice(r, 1)
            }
            t.length = 0
        }
        ...
        return this.animation.clear(), this.animatingElements.length = 0, this
    ...
    var l = e("zrender/tool/util"), h = e("zrender/config"), d = e("zrender/tool/event"), m = "stack", c = "tiled";
    return t.prototype = {
    ...
    return t.prototype = {
        type: o.COMPONENT_TYPE_TITLE, _buildShape: function () {
            ...
            var V = {
                ...
                z: this.getZBase(),
                style: {
                    y: m + p, color: this.titleOption.subtextStyle.color, text: a, textFont: h, textBaseline: "bottom"
                },
    ...
    var l = e("../util/ecData"), h = e("zrender/config"), d = e("zrender/tool/event"), m = e("zrender/tool/area"), c = e("zrender/tool/color"), p = e("zrender/tool/util"), u = e("zrender/shape/Base");
    return t.prototype = {
            ...
            if (h.length > 0) {
                if (this._lastItemTriggerId = -1, this._lastDataIndex != i || this._lastSeriesIndex != m[0]) {
                    ...
                    if ("function" == typeof a) {
                        for (var x = [], g = 0, y = h.length; y > g; g++)b = h[g].data[i], _ = this.getDataFromOption(b, "-"), x.push({
                            seriesIndex: m[g],
                            seriesName: h[g].name || "",
                            series: h[g],
                            dataIndex: i,
                        ...
                        for (var g = 0, y = h.length; y > g; g++)a = a.replace("{a" + g + "}", this._encodeHTML(h[g].name || "")), a = a.replace("{b" + g + "}", this._encodeHTML(n.getNameByIndex(i))), b = h[g].data[i], b = this.getDataFromOption(b, "-"), a = a.replace("{c" + g + "}", b instanceof Array ? b : this.numAddCommas(b));
                        this._tDom.innerHTML = a
                    } else {
                        this._curTicket = 0 / 0, a = this._encodeHTML(n.getNameByIndex(i));
                        for (var g = 0, y = h.length; y > g; g++)a += "<br/>" + this._encodeHTML(h[g].name || "") + " : ", b = h[g].data[i], b = this.getDataFromOption(b, "-"), a += b instanceof Array ? b : this.numAddCommas(b);
                        this._tDom.innerHTML = a
                    }
                }
        ...
        _showPolarTrigger: function (e, t) {
            ...
            if (r.length > 0) {
                for (var p, u, V, U = [], m = 0, c = r.length; c > m; m++) {
                    p = r[m].data;
                    for (var g = 0, y = p.length; y > g; g++)u = p[g], this._isSelected(u.name) && (u = null != u ? u : {
                        name: "",
                        value: {dataIndex: "-"}
        ...
        _showItemTrigger: function (e) {
            if (this._curTarget) {
                var t, i, n, a = l.get(this._curTarget, "series"), o = l.get(this._curTarget, "seriesIndex"), r = l.get(this._curTarget, "data"), h = l.get(this._curTarget, "dataIndex"), m = l.get(this._curTarget, "name"), c = l.get(this._curTarget, "value"), p = l.get(this._curTarget, "special"), u = l.get(this._curTarget, "special2"), V = [r, a, this.option], U = "";
                ...
                var y = d.getX(this._event), f = d.getY(this._event);
                this.deepQuery(V, "tooltip.axisPointer.show") && this.component.grid ? this._styleAxisPointer([a], this.component.grid.getX(), f, this.component.grid.getXend(), f, 0, y, f) : this._hide(), n !== !1 && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(i, y + 20, f - 20, U))
            }
        },
        _itemFormatter: {
        ...
        _styleAxisPointer: function (e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                ...
                for (var u = 0, V = e.length; V > u; u++)l = e[u], h = this.query(l, "tooltip.axisPointer.type"), m = h || m, h && (c[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || c[h].color, c[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || c[h].width, c[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || c[h].type);
                if ("line" === m) {
                    var U = c.line.width, g = t == n;
                    ...
                    if (d)if (m) {
                        ...
                        switch (d.type) {
                            ...
                            case s.CHART_TYPE_SCATTER:
                                for (var c = e.dataIndex, a = 0, o = f.length; o > a; a++)if (null == f[a]._mark && l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                    this._curTarget = f[a], g = f[a].style.x, y = d.type != s.CHART_TYPE_K ? f[a].style.y : f[a].style.y[0];
                                    break
                                }
                                break;
                            case s.CHART_TYPE_RADAR:
                            ...
                            case s.CHART_TYPE_PIE:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)if ("sector" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "name") == b) {
                                    ...
                                    g = this._curTarget.style.x + Math.cos(x) * _.r / 1.5, y = this._curTarget.style.y - Math.sin(x) * _.r / 1.5;
                                    break
                                }
                                break;
                            case s.CHART_TYPE_MAP:
                                for (var b = e.name, k = r.mapType, a = 0, o = f.length; o > a; a++)if ("text" === f[a].type && f[a]._mapType === k && f[a].style._name === b) {
                                    this._curTarget = f[a], g = this._curTarget.style.x + this._curTarget.position[0], y = this._curTarget.style.y + this._curTarget.position[1];
                                    break
                                }
                                break;
                            case s.CHART_TYPE_CHORD:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)if ("sector" === f[a].type && l.get(f[a], "name") == b) {
                                    this._curTarget = f[a];
                                    var _ = this._curTarget.style, x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                    return g = this._curTarget.style.x + Math.cos(x) * (_.r - 2), y = this._curTarget.style.y - Math.sin(x) * (_.r - 2), void this.zr.trigger(h.EVENT.MOUSEMOVE, {
                                        zrenderX: g,
                                        zrenderY: y
                                    })
                                }
                            ...
                            case s.CHART_TYPE_FORCE:
                                for (var b = e.name, a = 0, o = f.length; o > a; a++)if ("circle" === f[a].type && l.get(f[a], "name") == b) {
                                    this._curTarget = f[a], g = this._curTarget.position[0], y = this._curTarget.position[1];
                                    break
                                }
                        }
    ...
    t.prototype = {
        type: l.COMPONENT_TYPE_LEGEND, _buildShape: function () {
            ...
            var e, t, i, a, o, s, l, m, c = this.legendOption.data, p = c.length, u = this.legendOption.textStyle, V = this.zr.getWidth(), U = this.zr.getHeight(), g = this._itemGroupLocation.x, y = this._itemGroupLocation.y, f = this.legendOption.itemWidth, b = this.legendOption.itemHeight, _ = this.legendOption.itemGap;
            ...
            }, "vertical" === this.legendOption.orient && "right" === this.legendOption.x && (a.style.x -= f + 10,
            ...
            return {x: y, y: f, width: s, height: l, maxWidth: V}
    ...
    function h(e, t, i) {
        ...
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], c = e[2], p = e[3]; i > l; l++)n[l] = m([T(Math.floor(h), [0, 255]), T(Math.floor(d), [0, 255]), T(Math.floor(c), [0, 255]), p.toFixed(4) - 0], "rgba"), h += a, d += o, c += r, p += s;
    ...
    function p(e, t) {
        if (!E(e))return e;
        var i = K(e), n = i[3];
        return "undefined" == typeof n && (n = 1), e.indexOf("hsb") > -1 ? i = z(i) : e.indexOf("hsl") > -1 && (i = A(i)), t.indexOf("hsb") > -1 || t.indexOf("hsv") > -1 ? i = J(i) : t.indexOf("hsl") > -1 && (i = F(i)), i[3] = n, m(i, t)
    }
    ...
    function S(e, t) {
        ...
        null === t && (t = 1);
        var i = K(u(e));
        return i[3] = T(Number(t).toFixed(4), [0, 1]), m(i, "rgba")
    }
    ...
    return t.prototype = {
        type: s.COMPONENT_TYPE_TIMELINE, _buildShape: function () {
            ...
            for (var g, y, f, b, _, x = [], U = 0; p > U; U++)d = u[U], g = h[U].symbol && h[U].symbol.toLowerCase() || n, g.match("empty") ? (g = g.replace("empty", ""), f = !0) : f = !1, g.match("star") && (y = g.replace("star", "") - 0 || 5, g = "star"), t = h[U].textStyle ? l.merge(h[U].textStyle || {}, r) : r, b = t.align || "center", o ? (b = o > 0 ? "right" : "left", _ = [o * Math.PI / 180, d, m - 5]) : _ = !1, x.push({
                x: d,
                n: y,
                isEmpty: f,
                symbol: g,
            ...
            return this.timelineOption.autoPlay && this.stop(),
                this.currentIndex -= 1, this.currentIndex < 0 && (this.currentIndex = this.timelineOption.data.length - 1), this._onFrame(), this.currentIndex
        }, next: function () {
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        for (var i = n.merge(this.options, {
            ...
            var V = -Math.ceil(1e3 * Math.random()), U = Math.ceil(400 * Math.random()), g = Math.ceil(Math.random() * p), y = "random" == l.color ? a.random() : l.color;
            m[u] = new o({
                highlightStyle: {xStart: V, yStart: g, xEnd: V + U, yEnd: g, strokeColor: y, lineWidth: d},
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        ...
        for (var h = this.createTextShape(i.textStyle), d = this.createBackgroundShape(i.backgroundColor), m = s.x, c = s.y, p = s.r0 + 6, u = s.r - 6, V = s.color, U = a.lift(V, .1), g = new o({highlightStyle: n.clone(s)}), y = [], f = a.getGradientColors(["#ff6400", "#ffe100", "#97ff00"], 25), b = 15, _ = 240, x = 0; 16 > x; x++)y.push(new r({
            highlightStyle: {
                x: m,
                y: c,
                r0: p,
        ...
        if (null != i.progress) {
            ...
            for (var x = 0; 20 > x; x++)y[x].highlightStyle.color = k > x ? y[x]._color : U, e(y[x]);
            return e(h), void t()
        }
        return setInterval(function () {
            e(d), k += k >= 20 ? -20 : 1, e(g);
            for (var i = 0; 20 > i; i++)y[i].highlightStyle.color = k > i ? y[i]._color : U, e(y[i]);
            e(h), t()
        }, s.timeInterval)
    }, t
    ...
    return n.inherits(t, i), t.prototype._start = function (e, t) {
        ...
        return V.highlightStyle.x = U.highlightStyle.x = g.highlightStyle.x = y[1], V.highlightStyle.y = U.highlightStyle.y = g.highlightStyle.y = y[2], setInterval(function () {
            e(u), e(g), y[0] -= .3, V.rotation = y, e(V), e(U), e(l), t()
        }, c.timeInterval)
    }, t
    ...
    return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function () {
        ...
        function k(e, t, i, n) {
            ...
            if (a instanceof w) {
                ...
                if ("gradient" == a.type_) {
                    var p = a.x0_ / o, u = a.y0_ / r, U = a.x1_ / o, g = a.y1_ / r, y = L(e, p, u), f = L(e, U, g), b = f.x - y.x, _ = f.y - y.y;
                    h = 180 * Math.atan2(b, _) / Math.PI, 0 > h && (h += 360), 1e-6 > h && (h = 0)
                } else {
                    var y = L(e, a.x0_, a.y0_);
                    d = {x: (y.x - i.x) / s, y: (y.y - i.y) / l}, s /= o * J, l /= r * J;
                    var x = C.max(s, l);
                ...
                for (var v = k.length, W = k[0].color, I = k[v - 1].color, K = k[0].alpha * e.globalAlpha, S = k[v - 1].alpha * e.globalAlpha, T = [], E = 0; v > E; E++) {
                    var z = k[E];
        ...
        var C = Math, T = C.round, E = C.sin, z = C.cos, A = C.abs, M = C.sqrt, J = 10, F = J / 2, O = (+navigator.userAgent.match(/MSIE ([\d.]+)?/)[1], Array.prototype.slice);
        a(document);
        var P = {
            init: function (e) {
                var i = e || document;
        ...
        Q.clearRect = function () {
            ...
            i *= J;
            var r = o ? "at" : "wa", s = e + z(n) * i - F, l = t + E(n) * i - F, h = e + z(a) * i - F, d = t + E(a) * i - F;
            s != h || o || (s += .125);
            ...
            var p = L(this, t, i), u = [], V = 10, U = 10, g = f = 1;
            if (u.push(" <g_vml_:group", ' coordsize="', J * V, ",", J * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                var y = [], g = this.scaleX_, f = this.scaleY_;
                ...
                b.x = C.max(b.x, _.x, x.x, k.x), b.y = C.max(b.y, _.y, x.y, k.y), u.push("padding:0 ", T(b.x / J), "px ", T(b.y / J), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", y.join(""), ", SizingMethod='clip');")
            ...
            var r = this.m_, s = 1e3, l = 0, h = s, d = {
                x: 0,
                y: 0
            }, m = [], c = g(U(this.font), this.element_), p = y(c), u = this.element_.currentStyle, V = this.textAlign.toLowerCase();
            switch (V) {
                case"left":
                case"center":
                case"right":
            ...
            var b = r[0][0].toFixed(3) + "," + r[1][0].toFixed(3) + "," + r[0][1].toFixed(3) + "," + r[1][1].toFixed(3) + ",0,0", _ = T(f.x / J) + "," + T(f.y / J);
    ...
    var o = e("./config"), r = e("./tool/env"), s = e("./tool/event"), l = e("./tool/util"), h = e("./tool/vector"), d = e("./tool/matrix"), m = o.EVENT, c = e("./mixin/Eventful"), p = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], u = {
        resize: function (e) {
            ...
            }), n && this.painter.refresh(), this._dispatchAgency(this._lastHover, m.MOUSEWHEEL, e), this._mousemoveHandler(e)
            ...
            e = this._zrenderEventFixed(e), this.root.style.cursor = "default", this._isMouseDown = 0, this._mouseDownTarget = null, this._dispatchAgency(this._lastHover, m.MOUSEUP, e), this._processDrop(e), this._processDragEnd(e)
            ...
            var t = new Date;
            t - this._lastTouchMoment < m.touchClickDelay && (this._mobileFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < m.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = t), this.painter.clearHover()
        }
    }, V = function (e, t, o) {
    ...
    return g.prototype = {
        when: function (e, t) {
            ...
            var t = this, i = this._setter, l = this._getter, c = "spline" === e, p = function () {
                ...
                var U = u.length;
                if (U) {
                    var g = u[0].value, y = o(g), f = !1, b = y && o(g[0]) ? 2 : 1;
                    u.sort(function (e, t) {
                    ...
                    if (U) {
                        ...
                        var W, L, w, X, I, K, S, C = 0, T = 0;
                        if (f)var E = [0, 0, 0, 0];
                        var z = function (e, o) {
                            if (T > o) {
                                for (W = Math.min(C + 1, U - 1), L = W; L >= 0 && !(x[L] <= o); L--);
                                L = Math.min(L, U - 2)
                            } else {
                                for (L = C; U > L && !(x[L] > o); L++);
                                L = Math.min(L - 1, U - 2)
                            ...
                            var d = x[L + 1] - x[L];
                            if (0 !== d) {
                                if (w = (o - x[L]) / d, c)if (I = k[L], X = k[0 === L ? L : L - 1], K = k[L > U - 2 ? U - 1 : L + 1], S = k[L > U - 3 ? U - 1 : L + 2], y)r(X, I, K, S, w, w * w, w * w * w, l(e, V), b); else {
                                    var m;
                                    f ? (m = r(X, I, K, S, w, w * w, w * w * w, E, 1), m = h(E)) : m = s(X, I, K, S, w, w * w, w * w * w), i(e, V, m)
                                } else if (y)a(k[L], k[L + 1], w, l(e, V), b); else {
                                    var m;
                            ...
                            target: t._target, life: _, loop: t._loop, delay: t._delay, onframe: z, ondestroy: p
                        });
    ...
    function y(e, t, i, n, a, o, r, s, l, h) {
        ...
        for (var m, c, p = 0, u = -1, V = 0; d > V; V++) {
            var U = T[V], y = W.cubicAt(e, i, a, r, U);
            l > y || (0 > u && (u = W.cubicExtrema(t, n, o, s, E), E[1] < E[0] && u > 1 && g(), m = W.cubicAt(t, n, o, s, E[0]), u > 1 && (c = W.cubicAt(t, n, o, s, E[1]))), p += 2 == u ? U < E[0] ? t > m ? 1 : -1 : U < E[1] ? m > c ? 1 : -1 : c > s ? 1 : -1 : U < E[0] ? t > m ? 1 : -1 : m > s ? 1 : -1)
        }
        return p
    }
    ...
    function b(e, i, n, a, o, r, s, l) {
        ...
        for (var m = 0, c = 0; 2 > c; c++) {
            ...
            if (p + e > s) {
                ...
                0 > u && (u = C + u), (u >= a && o >= u || u + C >= a && o >= u + C) && (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d), m += d)
            }
        }
        return m
    }
        ...
        for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
            ...
            switch (k.command) {
                case"M":
                    ...
                    break;
                case"L":
                    if (g && r(d, m, L[0], L[1], t, n, a))return !0;
                    _ && (o += U(d, m, L[0], L[1], n, a)), d = L[0], m = L[1];
                    break;
                case"C":
                    if (g && s(d, m, L[0], L[1], L[2], L[3], L[4], L[5], t, n, a))return !0;
                    _ && (o += y(d, m, L[0], L[1], L[2], L[3], L[4], L[5], n, a)), d = L[4], m = L[5];
                    break;
                case"Q":
                    if (g && l(d, m, L[0], L[1], L[2], L[3], t, n, a))return !0;
                    _ && (o += f(d, m, L[0], L[1], L[2], L[3], n, a)), d = L[2], m = L[3];
                    break;
                case"A":
                    var v = L[0], W = L[1], w = L[2], X = L[3], I = L[4], K = L[5], S = Math.cos(I) * w + v, C = Math.sin(I) * X + W;
                    V ? (V = !1, c = S, p = C) : o += U(d, m, S, C);
                    var T = (n - v) * X / w + v;
                    if (g && h(v, W, X, I, I + K, 1 - L[7], t, T, a))return !0;
                    _ && (o += b(v, W, X, I, I + K, 1 - L[7], T, a)), d = Math.cos(I + K) * w + v, m = Math.sin(I + K) * X + W;
                    break;
                case"z":
    ...
    var L, v = e("./util"), W = e("./curve"), w = {}, X = {}, I = 0, K = 0, S = 5e3, C = 2 * Math.PI, T = [-1, -1, -1], E = [-1, -1];
    return {
        isInside: i,
        isOutside: o,
        getTextWidth: x,
    ...
    return d.prototype.doClip = function (e) {
        ...
        if ("undefined" != typeof i.text && i.text !== !1) {
            ...
            switch (d) {
                ...
                case"start":
                case"end":
                    var c = i.pointList || [[i.xStart || 0, i.yStart || 0], [i.xEnd || 0, i.yEnd || 0]], p = c.length;
                    if (2 > p)return;
                    var u, V, U, g;
                    switch (d) {
                        case"start":
                            u = c[1][0], V = c[0][0], U = c[1][1], g = c[0][1];
                            break;
                        case"end":
                            u = c[p - 2][0], V = c[p - 1][0], U = c[p - 2][1], g = c[p - 1][1]
                    }
                    s = V, l = g;
                    var y = Math.atan((U - g) / (V - u)) / Math.PI * 180;
                    0 > V - u ? y += 180 : 0 > U - g && (y += 360), h = 5, y >= 30 && 150 >= y ? (o = "center", r = "bottom", l -= h) : y > 150 && 210 > y ? (o = "right", r = "middle", s -= h) : y >= 210 && 330 >= y ? (o = "center", r = "top", l += h) : (o = "left", r = "middle", s += h);
                    break;
                case"specific":
    ...
    function o(e, i, n, a, o, r) {
        ...
        if (t(m) && t(c))if (t(l))r[0] = 0; else {
            ...
            if (t(U)) {
                ...
                var _ = Math.sqrt(U), x = m * l + 1.5 * s * (-c + _), k = m * l + 1.5 * s * (-c - _);
                x = 0 > x ? -Math.pow(-x, y) : Math.pow(x, y), k = 0 > k ? -Math.pow(-k, y) : Math.pow(k, y);
                var V = (-l - (x + k)) / (3 * s);
                V >= 0 && 1 >= V && (r[u++] = V)
            } else {
                var L = (2 * m * l - 3 * s * c) / (2 * Math.sqrt(m * m * m)), v = Math.acos(L) / 3, W = Math.sqrt(m), w = Math.cos(v), V = (-l - 2 * W * w) / (3 * s), b = (-l + W * (w + g * Math.sin(v))) / (3 * s), X = (-l + W * (w - g * Math.sin(v))) / (3 * s);
    ...
    function l(e, t, i, a, o, r, s, l, h, d, m) {
        ...
        for (var x = 0; 32 > x && !(U > p); x++) {
            ...
            if (k >= 0 && u > y)c = k, u = y; else {
                _[0] = n(e, i, o, s, L), _[1] = n(t, a, r, l, L);
                var v = V.distSquare(_, f);
                1 >= L && u > v ? (c = L, u = v) : p *= .5
            }
        }
    ...
    function u(e, t, i, n, a, o, r, s, l) {
        ...
        for (var g = 0; 32 > g && !(U > m); g++) {
            var y = d - m, x = d + m;
            b[0] = h(e, i, a, y), b[1] = h(t, n, o, y);
            var u = V.distSquare(b, f);
            if (y >= 0 && c > u)d = y, c = u; else {
    ...
    var V = e("./vector"), U = 1e-4, g = Math.sqrt(3), y = 1 / 3, f = V.create(), b = V.create(), _ = V.create();
    return {
        cubicAt: n,
        cubicDerivativeAt: a,
        cubicRootAt: o,
    ...
    return l.prototype = {
        constructor: l, updateNeedTransform: function () {
            ...
            var i = [e, t];
            return this.needTransform && this.invTransform && n.mulVector(i, this.invTransform, i), i
        }
    }, l
        ...
        setCalculable: function (e) {
            ...
            if (this.isDrop && e.target && !t.dragIn) {
                ...
                if (-1 === r) {
                    ...
                    for (var m = !1, c = s[o].data, u = 0, V = c.length; V > u; u++)c[u].name === i.name && "-" === c[u].value && (s[o].data[u].value = i.value, m = !0);
                    !m && s[o].data.push(i), l && l.add(i.name, a.style.color || a.style.strokeColor)
            ...
            for (var t, i, n, a, o = this.series, r = 0, s = {}, l = "__kener__stack__", d = this.component.legend, m = [], c = 0, p = 0, u = e.length; u > p; p++) {
                ...
                this.selectedMap[n] && (i = t.stack || l + e[p], null == s[i] ? (s[i] = r, m[r] = [e[p]], r++) : m[s[i]].push(e[p])), c = Math.max(c, t.data.length)
            }
            ...
            for (var n = this.series, a = 0, o = t.length; o > a; a++)for (var r = 0, s = t[a].length; s > r; r++) {
                var l = t[a][r], h = "xy" == i ? 0 : "", d = this.component.grid, m = e[l];
                if ("-1" != i.indexOf("x")) {
                    m["counter" + h] > 0 && (m["average" + h] = m["sum" + h] / m["counter" + h]);
                    var c = this.component.xAxis.getAxis(n[l].xAxisIndex || 0).getCoord(m["average" + h]);
                    m["averageLine" + h] = [[c, d.getYend()], [c, d.getY()]], m["minLine" + h] = [[m["minX" + h], d.getYend()], [m["minX" + h], d.getY()]], m["maxLine" + h] = [[m["maxX" + h], d.getYend()], [m["maxX" + h], d.getY()]], m.isHorizontal = !1
                }
                if (h = "xy" == i ? 1 : "", "-1" != i.indexOf("y")) {
                    m["counter" + h] > 0 && (m["average" + h] = m["sum" + h] / m["counter" + h]);
                    var p = this.component.yAxis.getAxis(n[l].yAxisIndex || 0).getCoord(m["average" + h]);
                    m["averageLine" + h] = [[d.getX(), p], [d.getXend(), p]], m["minLine" + h] = [[d.getX(), m["minY" + h]], [d.getXend(), m["minY" + h]]], m["maxLine" + h] = [[d.getX(), m["maxY" + h]], [d.getXend(), m["maxY" + h]]], m.isHorizontal = !0
                }
            }
            ...
            if (s.show) {
                ...
                m.text = this._getLabelText(t, i, n, "emphasis"), m.textPosition = r.show ? e.style.textPosition : null == s.position ? "horizontal" === a ? "right" : "top" : s.position, m.textColor = h.color, m.textFont = this.getFont(h), m.textAlign = h.align, m.textBaseline = h.baseline
            }
            return e
            ...
            var d = this._markLine(e, a), m = a.large;
            if (m) {
                var c = new l({style: {shapeList: d}}), p = d[0];
                if (p) {
                    U.merge(c.style, p.style), U.merge(c.highlightStyle = {}, p.highlightStyle), c.style.brushType = "stroke", c.zlevel = this.getZlevelBase(), c.z = this.getZBase() + 1, c.hoverable = !1;
                    for (var u in i)c[u] = U.clone(i[u])
                }
                this.shapeList.push(c), this.zr.addShape(c), c._mark = "largeLine";
                var V = a.effect;
                V.show && (c.effect = V)
            } else {
            ...
            var a, o, r, s, l, m, c, p = [], u = t.data, V = n.dataRange, g = n.legend, y = this.zr.getWidth(), f = this.zr.getHeight();
            ...
            return function (i, n) {
                ...
                for (var m = n.data, c = [], p = this.zr.getWidth(), u = this.zr.getHeight(), g = 0; g < m.length; g++) {
                    var y = m[g];
                    if (t(y[0]) && t(y[1])) {
                        var f = this.deepMerge(y), b = [f, n], _ = l, x = null != f.value ? f.value : "";
                        if (r) {
                            _ = isNaN(x) ? _ : r.getColor(x);
                            var k = this.deepQuery(b, "itemStyle.normal.color") || _, L = this.deepQuery(b, "itemStyle.emphasis.color") || k;
                            if (null == k && null == L)continue
                        }
                        y[0].tooltip = f.tooltip || n.tooltip || {trigger: "item"}, y[0].name = y[0].name || "", y[1].name = y[1].name || "", y[0].value = x, c.push({
                ...
                var v = this.query(n, "bundling.enable");
                if (v) {
                    var W = new V;
                    W.maxTurningAngle = this.query(n, "bundling.maxTurningAngle") / 180 * Math.PI, c = W.run(c)
                }
                n.name = a.name;
                for (var w = [], g = 0, X = c.length; X > g; g++) {
                    var I = c[g], K = I.rawEdge || I, y = K.rawData, x = null != y.value ? y.value : "", S = this.getMarkLineShape(n, i, y, g, I.points, v, K.color);
                    S._mark = "line";
                    var C = this.deepMerge([y[0], y[1], n], "effect");
                    C.show && (S.effect = C, S.effect.large = n.large), a.type === h.CHART_TYPE_MAP && (S._geo = [this.getMarkGeo(y[0]), this.getMarkGeo(y[1])]), d.pack(S, a, i, y[0], g, y[0].name + ("" !== y[1].name ? " > " + y[1].name : ""), x), w.push(S)
                }
                return w
            }
            ...
            var g = this.deepQuery(u, "symbolRotate"), y = this.deepMerge(u, "itemStyle.normal"), f = this.deepMerge(u, "itemStyle.emphasis"), b = null != y.borderWidth ? y.borderWidth : y.lineStyle && y.lineStyle.width;
            null == b && (b = h.match("empty") ? 2 : 0);
            var _ = null != f.borderWidth ? f.borderWidth : f.lineStyle && f.lineStyle.width;
            null == _ && (_ = b + 2);
            var x = this.getItemStyleColor(y.color, t, o, i), k = this.getItemStyleColor(f.color, t, o, i), L = new a({
                style: {
            ...
            return h.match("image") && (L.style.image = h.replace(new RegExp("^image:\\/\\/"), ""), L = new n({
                style: L.style,
                highlightStyle: L.highlightStyle,
                clickable: this.deepQuery(u, "clickable")
            })), null != g && (L.rotation = [g * Math.PI / 180, s, l]), h.match("star") && (L.style.iconType = "star", L.style.n = h.replace("empty", "").replace("star", "") - 0 || 5), "none" === h && (L.invisible = !0, L.hoverable = !1), L = this.addLabel(L, e, i, r, p), h.match("empty") && (null == L.style.textColor && (L.style.textColor = L.style.strokeColor), null == L.highlightStyle.textColor && (L.highlightStyle.textColor = L.highlightStyle.strokeColor)), d.pack(L, e, t, i, o, r), L._x = s, L._y = l, L._dataIndex = o, L._seriesIndex = t, L
        }, getMarkLineShape: function (e, t, i, n, a, r, l) {
            var h = null != i[0].value ? i[0].value : "-", d = null != i[1].value ? i[1].value : "-", m = [i[0].symbol || e.symbol[0], i[1].symbol || e.symbol[1]], c = [i[0].symbolSize || e.symbolSize[0], i[1].symbolSize || e.symbolSize[1]];
            c[0] = "function" == typeof c[0] ? c[0](h) : c[0], c[1] = "function" == typeof c[1] ? c[1](d) : c[1];
            ...
            var g = V.lineStyle, y = U.lineStyle, f = g.width;
            ...
            return r ? (L.pointList = a, L.smooth = _) : (L.xStart = a[0][0], L.yStart = a[0][1], L.xEnd = a[1][0], L.yEnd = a[1][1], L.curveness = _, k.updatePoints(k.style)), k = this.addLabel(k, e, i[0], i[0].name + " : " + i[1].name)
        }, getLargeMarkPointShape: function (e, t) {
            var i, n, a, o, s, l, h = this.series[e], d = this.component, m = t.data, c = d.dataRange, p = d.legend, u = [m[0], t];
            ...
            if (this.option.animation && !this.option.renderAsImage && a.length < i && !this.motionlessOnce) {
                for (var m = 0, c = n.length; c > m; m++)t = this._getAnimationKey(n[m]), t.match("undefined") ? this.zr.delShape(n[m].id) : (t += n[m].type, l[t] ? this.zr.delShape(n[m].id) : l[t] = n[m]);
                for (var m = 0, c = a.length; c > m; m++)t = this._getAnimationKey(a[m]), t.match("undefined") ? this.zr.addShape(a[m]) : (t += a[m].type, d[t] = a[m]);
                ...
                for (var m = 0, c = a.length; c > m; m++)this.zr.addShape(a[m])
            }
            ...
            switch (t.type) {
                ...
                case"sector":
                case"circle":
                    o ? "sector" === t.type ? m.sector(this.zr, e, t, i, n) : this.zr.addShape(t) : m.ring(this.zr, e, t, i + (d.get(t, "dataIndex") || 0) % 20 * 100, n);
                    break;
                case"text":
            ...
            if (!e && this.clearEffectShape(), e = e || this.shapeList, null != e) {
                ...
                for (var i, n = 0, a = e.length; a > n; n++)i = e[n], i._mark && i.effect && i.effect.show && c[i._mark] && (c[i._mark](this.zr, this.effectList, i, t), this.effectList[this.effectList.length - 1]._mark = i._mark)
            }
    ...
    var i = e("zrender/shape/Base"), n = e("./Icon"), a = e("zrender/shape/Line"), o = new a({}), r = e("zrender/shape/BezierCurve"), s = new r({}), l = e("zrender/tool/area"), h = e("zrender/shape/util/dashedLineTo"), d = e("zrender/tool/util"), m = e("zrender/tool/curve");
    return t.prototype = {
        type: "mark-line", brush: function (e, t) {
            ...
            if ("none" != t.symbol[i]) {
                ...
                var o = t.xStart, r = t.yStart, s = t.xEnd, l = t.yEnd, h = 0 === i ? o : s, d = 0 === i ? r : l, c = t.curveness || 0, p = null != t.symbolRotate[i] ? t.symbolRotate[i] - 0 : 0;
                if (p = p / 180 * Math.PI, "arrow" == a && 0 === p)if (0 === c) {
                    var u = 0 === i ? -1 : 1;
                    p = Math.PI / 2 + Math.atan2(u * (l - r), u * (s - o))
                } else {
                    var V = t.cpX1, U = t.cpY1, g = m.quadraticDerivativeAt, y = g(o, V, s, i), f = g(r, U, l, i);
    ...
    return t.prototype = {
        type: "symbol", buildPath: function (e, t) {
            ...
            if (0 !== n)for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), m = i[0]instanceof Array, c = t.size ? t.size : 2, p = c, u = c / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                ...
                for (var g = a; o > g; g++)if (t.random && (r = t["randomMap" + g % 20] / 100, p = c * r * r, u = p / 2), m ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p)e.rect(s - u, l - u, p, p); else switch (t.iconType) {
                    case"circle":
    ...
    function t(e, t, i, n, a) {
        ...
        o = t.style.pointList;
        var m = o.length;
        i.style.pointList = m == s ? o : s > m ? o.concat(r.slice(m)) : o.slice(0, s), e.addShape(i), i.__animating = !0, e.animate(i.id, "style").when(n, {pointList: r}).during(function () {
    ...
    function n(e, t, n, a, o) {
        ...
        i(n, t, "x", "y", "width", "height"), n.position = t.position, e.addShape(n), (m[0] != t.position[0] || m[1] != t.position[1]) && e.animate(n.id, "").when(a, {position: m}).start(o), n.__animating = !0, e.animate(n.id, "style").when(a, {
            x: s,
            y: l,
            width: h,
            height: d
    ...
    function o(e, t, i, n, a) {
        ...
        i.__animating = !0, "r" != i._animationAdd ? (i.style.r0 = 0, i.style.r = 0, i.rotation = [2 * Math.PI, o, r], e.addShape(i), e.animate(i.id, "style").when(n, {
            ...
            i.__animating = !1
        }).start(a), e.animate(i.id, "").when(Math.round(n / 3 * 2), {rotation: [0, o, r]}).start(a)) : (i.style.r0 = i.style.r, e.addShape(i), e.animate(i.id, "style").when(n, {r0: s}).done(function () {
            i.__animating = !1
        }).start(a))
    }
    ...
    function p(e, t, i, n, a) {
        ...
        if (o.curveness > 0) {
            i.updatePoints(o);
            var m = {p: 0}, c = o.cpX1, p = o.cpY1, u = [], U = [], g = V.quadraticSubdivide;
            e.animation.animate(m).when(n, {p: 1}).during(function () {
                g(s, c, h, m.p, u), g(l, p, d, m.p, U), o.cpX1 = u[1], o.cpY1 = U[1], o.xEnd = u[2], o.yEnd = U[2], e.modShape(i)
            }).done(r).start(a)
    ...
    function t(e, t, i, n) {
        var a, r = i.effect, l = r.color || i.style.strokeColor || i.style.color, d = r.shadowColor || l, m = r.scaleSize, c = r.bounceDistance, p = "undefined" != typeof r.shadowBlur ? r.shadowBlur : m;
        ...
        var y = a.style.x + a.style.width / 2 / V, f = a.style.y + a.style.height / 2 / V;
        "scale" === r.type ? (e.modShape(a.id, {scale: [.1, .1, y, f]}), e.animate(a.id, "", r.loop).when(g, {scale: [1, 1, y, f]}).done(function () {
            i.effect.show = !1, e.delShape(a.id)
        }).start()) : e.animate(a.id, "style", r.loop).when(g, {y: a.style.y - c}).when(2 * g, {y: a.style.y}).done(function () {
            i.effect.show = !1, e.delShape(a.id)
        }).start()
    }

    function i(e, t, i, n) {
        var a = i.effect, o = a.color || i.style.strokeColor || i.style.color, r = a.scaleSize, s = a.shadowColor || o, l = "undefined" != typeof a.shadowBlur ? a.shadowBlur : 2 * r, h = window.devicePixelRatio || 1, m = new d({
            zlevel: n,
            position: i.position,
            scale: i.scale,
            style: {
    ...
    function n(e, t, i, n, a) {
        var s = i.effect, h = i.style, d = s.color || h.strokeColor || h.color, m = s.shadowColor || h.strokeColor || d, V = h.lineWidth * s.scaleSize, U = "undefined" != typeof s.shadowBlur ? s.shadowBlur : V, g = new r({
            zlevel: n,
            style: {x: U, y: U, r: V, color: d, shadowColor: m, shadowBlur: U},
            hoverable: !1
        }), y = 0;
        if (u && !a) {
            var n = g.zlevel;
            g = e.shapeToImage(g, 2 * (V + U), 2 * (V + U)), g.zlevel = n, g.hoverable = !1, y = U
        }
        ...
        if (i instanceof c) {
            for (var b = [0], _ = 0, x = h.pointList, k = h.controlPointList, L = 1; L < x.length; L++) {
                if (k) {
                    var v = k[2 * (L - 1)], W = k[2 * (L - 1) + 1];
                    _ += p.dist(x[L - 1], v) + p.dist(v, W) + p.dist(W, x[L])
                } else _ += p.dist(x[L - 1], x[L]);
                b.push(_)
            }
            for (var w = {p: 0}, X = e.animation.animate(w, {loop: s.loop}), L = 0; L < b.length; L++)X.when(b[L] * s.period, {p: L});
            X.during(function () {
            ...
            }).done(f).start(), X.duration = _ * s.period, g.effectAnimator = X
        } else {
            var I = h.xStart - y, K = h.yStart - y, S = h.xEnd - y, C = h.yEnd - y;
            g.style.x = I, g.style.y = K;
            var T = (S - I) * (S - I) + (C - K) * (C - K), E = Math.round(Math.sqrt(Math.round(T * s.period * s.period)));
            if (i.style.curveness > 0) {
                var z = h.cpX1 - y, A = h.cpY1 - y;
                g.effectAnimator = e.animation.animate(g, {loop: s.loop}).when(E, {p: 1}).during(function (t, i) {
                    g.style.x = l.quadraticAt(I, z, S, i), g.style.y = l.quadraticAt(K, A, C, i), a || e.modShape(g)
                }).done(f).start()
    ...
    function a(e, t, i, a) {
        var o = new m({style: {shapeList: []}, zlevel: a, hoverable: !1}), r = i.style.shapeList, s = i.effect;
        o.position = i.position;
        for (var l = 0, h = [], d = 0; d < r.length; d++) {
            r[d].effect = s;
            var c = n(e, null, r[d], a, !0), p = c.effectAnimator;
            o.style.shapeList.push(c), p.duration > l && (l = p.duration), 0 === d && (o.style.color = c.style.color, o.style.shadowBlur = c.style.shadowBlur, o.style.shadowColor = c.style.shadowColor), h.push(p)
        }
    ...
    var o = e("../util/ecData"), r = e("zrender/shape/Circle"), s = e("zrender/shape/Image"), l = e("zrender/tool/curve"), h = e("../util/shape/Icon"), d = e("../util/shape/Symbol"), m = e("zrender/shape/ShapeBundle"), c = e("zrender/shape/Polyline"), p = e("zrender/tool/vector"), u = e("zrender/tool/env").canvasSupported;
    ...
    var r = e("../data/KDTree"), s = e("zrender/tool/vector"), l = s.create, h = s.distSquare, d = s.dist, m = s.copy, c = s.clone;
    return n.prototype.getStartPoint = function () {
        ...
        constructor: o, run: function (e) {
            ...
            function n(e, i) {
                for (var n = [], a = 0, o = 0; o < e.length; o++)a > 0 && t(e[o], n[a - 1]) || (n[a++] = c(e[o]));
            ...
            var d = [], m = function (e, t) {
                for (var a, o = 0; o < e.length; o++) {
                    ...
                    if (r.edgeList[0] && r.edgeList[0].edge instanceof i) {
                        ...
                        a = t ? t.slice() : [], a.unshift(r.mp0), a.push(r.mp1), m(s, a)
            ...
            for (var c = new r(i, 4), p = [], u = l(), V = l(), U = 0, g = l(), y = l(), f = 0, h = 0; h < i.length; h++) {
                var d = i[h];
                if (!d.group) {
                    c.nearestN(d, this.maxNearestEdge, t, p);
                    for (var b = 0, _ = null, x = null, k = 0; k < p.length; k++) {
                        var L = p[k], v = 0;
                        L.group ? L.group !== x && (x = L.group, U = this._calculateGroupEdgeInk(L.group, d, u, V), v = L.group.ink + d.ink - U) : (U = this._calculateEdgeEdgeInk(d, L, u, V), v = L.ink + d.ink - U), v > b && (b = v, _ = L, m(y, V), m(g, u), f = U)
                    }
                    if (_) {
                        s += b;
                        var W;
                        _.group || (W = new a, o.push(W), W.addEdge(_)), W = _.group, m(W.mp0, g), m(W.mp1, y), W.ink = f, _.group.addEdge(d)
                    } else {
                        var W = new a;
                        o.push(W), m(W.mp0, d.getStartPoint()), m(W.mp1, d.getEndPoint()), W.ink = d.ink, W.addEdge(d)
                    }
                }
            }
            ...
            return function (a, o, r, l) {
                var m = Math.cos(this.maxTurningAngle), c = Math.tan(this.maxTurningAngle);
    ...
    return r.prototype = {
        type: "star", buildPath: function (e, t) {
            ...
            if (o && !(2 > o)) {
                ...
                var u = t.pointList = [];
                u.push([c, p]);
                for (var V, U = 0, g = 2 * o - 1; g > U; U++)V = U % 2 === 0 ? h : l, u.push([r + V * n(m), s + V * i(m)]), m += d;
    ...
    return function (e, i, n, a) {
        ...
        for (var u = 0, V = e.length; V > u; u++) {
            ...
            var g = t.distance(U, o), y = t.distance(U, r), f = g + y;
            0 !== f && (g /= f, y /= f), t.scale(m, d, -g), t.scale(c, d, y);
    ...
    return n.prototype._buildTree = function (e, n, a, o) {
        ...
        for (a.data !== e && (d++, this._addNearest(d, h, a)), e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right)); r--;) {
            a = o[r];
            var h = e.array[a.axis] - a.data.array[a.axis], m = 0 > h, c = !1;
            h *= h, (t > d || h < s[d - 1].dist) && (h = i(a.data, e), (t > d || h < s[d - 1].dist) && a.data !== e && (t > d && d++, this._addNearest(d, h, a)), c = !0), m ? (c && a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (c && a.left && (o[r++] = a.left), a.right && (o[r++] = a.right))
        }
    ...
    var a = e("./vector"), o = e("./curve"), r = a.create(), s = a.create(), l = a.create(), h = function (e, t, i, n, o, h, d, m) {
        if (Math.abs(n - o) >= 2 * Math.PI)return d[0] = e - i, d[1] = t - i, m[0] = e + i, void(m[1] = t + i);
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATAZOOM, _buildShape: function () {
            ...
            for (var c, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++)c = this.getDataFromOption(u[l], 0), this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]), isNaN(c) && (c = 0), V = Math.max(V, c), U = Math.min(U, c);
            var g = V - U, y = [], f = e / (i - (i > 1 ? 1 : 0)), b = t / (i - (i > 1 ? 1 : 0)), _ = 1;
            "horizontal" == this.zoomOption.orient && 1 > f ? _ = Math.floor(3 * i / e) : "vertical" == this.zoomOption.orient && 1 > b && (_ = Math.floor(3 * i / t));
            for (var l = 0, h = i; h > l; l += _)c = this.getDataFromOption(u[l], 0), this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]), isNaN(c) && (c = 0), y.push("horizontal" == this.zoomOption.orient ? [this._location.x + f * l, this._location.y + t - 1 - Math.round((c - U) / g * (t - 10))] : [this._location.x + 1 + Math.round((c - U) / g * (e - 10)), this._location.y + b * (h - l - 1)]);
            "horizontal" == this.zoomOption.orient ? (y.push([this._location.x + e, this._location.y + t]), y.push([this._location.x, this._location.y + t])) : (y.push([this._location.x, this._location.y]), y.push([this._location.x, this._location.y + t])), this.shapeList.push(new a({
                zlevel: this.getZlevelBase(), z: this.getZBase(), style: {
                    pointList: y, color: this.zoomOption.dataBackgroundColor
                }, hoverable: !1
            }))
            ...
            var d = this._zoom.seriesIndex[0], m = this.option.series[d][e + "Index"] || 0, c = this.option[e][m].type, p = this._zoom.scatterMap[d][e.charAt(0)].min, u = this._zoom.scatterMap[d][e.charAt(0)].max, V = u - p;
            if ("value" == c)return {start: p + V * this._zoom.start / 100, end: p + V * this._zoom.end / 100};
            if ("time" == c) {
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_CATEGORY, _getReformedLabel: function (e) {
            ...
            }, this.shapeList.push(new a(e))); else for (var U, g = "left" == this.option.position ? n.inside ? this.grid.getX() + 1 : this.grid.getX() - o - 1 : n.inside ? this.grid.getXend() - o - 1 : this.grid.getXend() + 1, V = c; i > V; V += h)(!l || l(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - (V >= 0 ? m : 0), s), e = {
                _axisShape: "axisTick",
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
            ...
            var e, t, i = this.option.data, a = this.option.data.length, o = this.option.axisLabel, r = o.rotate, l = o.margin, h = o.clickable, d = o.textStyle, m = "function" == typeof o.interval ? o.interval : !1;
            if (this.isHorizontal()) {
                var c, p;
                "bottom" == this.option.position ? (c = this.grid.getYend() + l, p = "top") : (c = this.grid.getY() - l, p = "bottom");
                for (var u = 0; a > u; u += this._interval)m && !m(u, i[u]) || "" === this._getReformedLabel(u) || (t = s.merge(i[u].textStyle || {}, d), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase() + 3,
                    hoverable: !1,
                    style: {
            ...
            var l = s.length, h = "function" == typeof this.option.axisLabel.interval ? this.option.axisLabel.interval : !1, d = n.onGap, m = d ? this.getGap() / 2 : "undefined" == typeof d && this.option.boundaryGap ? this.getGap() / 2 : 0;
            if (i -= d || "undefined" == typeof d && this.option.boundaryGap ? 1 : 0, this.isHorizontal())for (var c, p = this.grid.getY(), u = this.grid.getYend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (c = this.subPixelOptimize(this.getCoordByIndex(V) + m, r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {
            ...
            }, this.shapeList.push(new a(e))); else for (var U, g = this.grid.getX(), y = this.grid.getXend(), V = 0; i > V; V += this._interval)(!h || h(V, t[V])) && (U = this.subPixelOptimize(this.getCoordByIndex(V) - m, r), e = {
                zlevel: this.getZlevelBase(),
                z: this.getZBase(),
                hoverable: !1,
                style: {
            ...
            if (n instanceof Array) {
                ...
                if (this.isHorizontal())for (var d, m = this.grid.getY(), c = this.grid.getHeight(), p = this.grid.getX(), u = 0; r >= u; u += this._interval)s && !s(u, t[u]) && r > u || (d = r > u ? this.getCoordByIndex(u) + h : this.grid.getXend(), e = {
                    ...
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {x: p, y: m, width: d - p, height: c, color: n[u / this._interval % a]}
                }, this.shapeList.push(new o(e)), p = d); else for (var V, U = this.grid.getX(), g = this.grid.getWidth(), y = this.grid.getYend(), u = 0; r >= u; u += this._interval)s && !s(u, t[u]) && r > u || (V = r > u ? this.getCoordByIndex(u) - h : this.grid.getY(), e = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    hoverable: !1,
                    style: {x: U, y: V, width: g, height: y - V, color: n[u / this._interval % a]}
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_AXIS_VALUE, _buildShape: function () {
            ...
            if (t)for (var i = 0, n = this._valueList.length; n > i; i++)"function" == typeof t ? this._valueLabel.push(e ? t.call(this.myChart, this._valueList[i], e) : t.call(this.myChart, this._valueList[i])) : "string" == typeof t && this._valueLabel.push(e ? s.format(t, this._valueList[i]) : t.replace("{value}", this._valueList[i])); else if (e)for (var i = 0, n = this._valueList.length; n > i; i++)this._valueLabel.push(s.format(e, this._valueList[i]));
            else for (var i = 0, n = this._valueList.length; n > i; i++)this._valueLabel.push(this.numAddCommas(this._valueList[i]))
    ...
    function h(e, t, n) {
        var s, h = n || +_.slice(-1), u = l((t - e) / h, b), U = o(t - e), y = o(e, -1, 1), f = o(t, -1);
        if (r(U, u), r(y, u, 1), r(f, u), n ? s = m(y, f, h) : h = d(y, f), i(e) && i(t) && e * t >= 0) {
            if (h > t - e)return p(e, t, h);
            h = c(e, t, n, y, f, h)
        }
        var L = V(e, t, y.c, f.c);
        return y.c = L[0], f.c = L[1], (x || k) && g(e, t, y, f), a(y.c, f.c, h, f.e)
    }
    ...
    function m(e, i, n) {
        ...
        return m > 1.1 * s && (m = w(m / s / 2) * s, r += m, o += m), e.c = r, i.c = o, s
    }
    ...
    function y(e, t, i) {
        ...
        for (var g = n.length; g--;) {
            ...
            for (var y = m.length; y--;)l % m[y][0] === 0 && (d /= m[y][1]);
            p[g] = [i, l, h, d].join(), c[g] = {secs: i, step: l, delta: h, score: d}
        }
    ...
    var f, b, _, x, k, L = [10, 20, 25, 50], v = [4, 5, 6], W = Math, w = W.round, X = W.floor, I = W.ceil, K = W.abs;
    return n
});